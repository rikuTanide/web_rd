...
define("send.dart.bootstrap", ["web/send", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "send.dart") {
          child.main();
          return true;
        }
      }
    }
  dart_sdk.dart.trackLibraries("send.dart.bootstrap", {
    "send.dart.bootstrap": bootstrap
  }, '');
  return {
    bootstrap: bootstrap
  };
