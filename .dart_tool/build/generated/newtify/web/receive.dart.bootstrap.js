...
let modulePaths = {
 ...
 "packages/newtify/consts": "packages/newtify/consts.ddc",
 "web/receive": "receive.ddc"
};
...
define("receive.dart.bootstrap", ["web/receive", "dart_sdk"], function(app, dart_sdk) {
...
var baseUrl = (function () {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        if (childName === "receive.dart") {
          child.main();
          return true;
        }
      }
    }
  dart_sdk.dart.trackLibraries("receive.dart.bootstrap", {
    "receive.dart.bootstrap": bootstrap
  }, '');
  return {
    bootstrap: bootstrap
  };
